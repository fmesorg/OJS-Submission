<?php /* Smarty version 2.6.26, created on 2019-06-29 13:39:41
         compiled from subscription/users.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'subscription/users.tpl', 17, false),array('function', 'url', 'subscription/users.tpl', 21, false),array('function', 'html_options_translate', 'subscription/users.tpl', 23, false),array('function', 'icon', 'subscription/users.tpl', 53, false),array('function', 'page_info', 'subscription/users.tpl', 68, false),array('function', 'page_links', 'subscription/users.tpl', 69, false),array('modifier', 'escape', 'subscription/users.tpl', 30, false),array('modifier', 'concat', 'subscription/users.tpl', 51, false),array('modifier', 'to_array', 'subscription/users.tpl', 52, false),array('modifier', 'assign', 'subscription/users.tpl', 52, false),array('modifier', 'truncate', 'subscription/users.tpl', 53, false),array('block', 'iterate', 'subscription/users.tpl', 45, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', $this->_tpl_vars['pageTitle']); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<form method="post" id="submit" action="<?php if ($this->_tpl_vars['subscriptionId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectSubscriber','path' => $this->_tpl_vars['redirect'],'subscriptionId' => $this->_tpl_vars['subscriptionId']), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectSubscriber','path' => $this->_tpl_vars['redirect']), $this);?>
<?php endif; ?>">
...
?><a href="<?php if ($this->_tpl_vars['subscriptionId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectSubscriber','path' => $this->_tpl_vars['redirect'],'searchInitial' => $this->_tpl_vars['letter'],'subscriptionId' => $this->_tpl_vars['subscriptionId']), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectSubscriber','path' => $this->_tpl_vars['redirect'],'searchInitial' => $this->_tpl_vars['letter']), $this);?>
...
<?php endif; ?></a> <?php endforeach; endif; unset($_from); ?><a href="<?php if ($this->_tpl_vars['subscriptionId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectSubscriber','path' => $this->_tpl_vars['redirect'],'subscriptionId' => $this->_tpl_vars['subscriptionId']), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectSubscriber','path' => $this->_tpl_vars['redirect']), $this);?>
...
<tr valign="top">
	<td><?php if ($this->_tpl_vars['isJournalManager']): ?><a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'manager','op' => 'userProfile','path' => $this->_tpl_vars['userid']), $this);?>
...
<?php if ($this->_tpl_vars['isJournalManager']): ?></a><?php endif; ?></td>
...
&nbsp;<?php echo $this->_plugins['function']['icon'][0][0]->smartyIcon(array('name' => 'mail','url' => $this->_tpl_vars['url']), $this);?>
	...
	<td align="right" class="nowrap">
		<a href="<?php if ($this->_tpl_vars['subscriptionId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editSubscription','path' => ((is_array($_tmp=$this->_tpl_vars['redirect'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['subscriptionId']) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['subscriptionId'])),'userId' => $this->_tpl_vars['user']->getId()), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createSubscription','path' => $this->_tpl_vars['redirect'],'userId' => $this->_tpl_vars['user']->getId()), $this);?>
<?php endif; ?>" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.subscriptions.select"), $this);?>
</a>
	</td>
</tr>
...
<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'selectSubscriber','path' => $this->_tpl_vars['redirect']), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'selectSubscriberUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'selectSubscriberUrl'));?>

<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createUser','source' => $this->_tpl_vars['selectSubscriberUrl']), $this);?>
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.people.createUser"), $this);?>
</a>
	</div>
