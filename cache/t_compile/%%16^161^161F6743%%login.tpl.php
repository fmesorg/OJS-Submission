...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'core:user/login.tpl', 45, false),array('function', 'url', 'core:user/login.tpl', 57, false),array('modifier', 'strip_unsafe_html', 'core:user/login.tpl', 79, false),array('modifier', 'escape', 'core:user/login.tpl', 79, false),)), $this); ?>
...
</label><input style="float:right;" type="submit" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.login"), $this);?>
" class="button" /></td>
	...
	<tr>
		...
		<td><?php if (! $this->_tpl_vars['hideRegisterLink']): ?> <a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => $this->_tpl_vars['registerOp']), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => $this->_tpl_vars['registerLocaleKey']), $this);?>
</a></td>

		<td><a style="float:right;" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'login','op' => 'lostPassword'), $this);?>
