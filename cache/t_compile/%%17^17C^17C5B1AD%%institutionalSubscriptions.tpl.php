<?php /* Smarty version 2.6.26, created on 2019-06-29 13:25:04
         compiled from subscription/institutionalSubscriptions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'subscription/institutionalSubscriptions.tpl', 17, false),array('function', 'translate', 'subscription/institutionalSubscriptions.tpl', 17, false),array('function', 'html_options_translate', 'subscription/institutionalSubscriptions.tpl', 27, false),array('function', 'html_select_date', 'subscription/institutionalSubscriptions.tpl', 54, false),array('function', 'icon', 'subscription/institutionalSubscriptions.tpl', 89, false),array('function', 'page_info', 'subscription/institutionalSubscriptions.tpl', 110, false),array('function', 'page_links', 'subscription/institutionalSubscriptions.tpl', 111, false),array('modifier', 'escape', 'subscription/institutionalSubscriptions.tpl', 27, false),array('modifier', 'concat', 'subscription/institutionalSubscriptions.tpl', 86, false),array('modifier', 'assign', 'subscription/institutionalSubscriptions.tpl', 87, false),array('modifier', 'to_array', 'subscription/institutionalSubscriptions.tpl', 88, false),array('modifier', 'date_format', 'subscription/institutionalSubscriptions.tpl', 93, false),array('block', 'iterate', 'subscription/institutionalSubscriptions.tpl', 82, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('pageTitle', "manager.institutionalSubscriptions"); ?><?php echo ''; ?><?php $this->assign('pageId', "manager.institutionalSubscriptions"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.individualSubscriptions"), $this);?>
	...
	<li class="current"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'subscriptions','path' => 'institutional'), $this);?>
...
<form method="post" id="submit" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'subscriptions','path' => 'institutional'), $this);?>
">
...
<table width="100%" class="listing">
	...
	<tr class="heading" valign="bottom">
		<td width="30%"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.subscriptions.institutionName"), $this);?>
</td>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'subscriptions','item' => 'subscription')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<tr valign="top">
		<td>
			...
			<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'subscriptions','path' => 'institutional','escape' => false), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'redirectUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'redirectUrl'));?>
			...
			<?php echo ((is_array($_tmp=$this->_tpl_vars['subscription']->getInstitutionName())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<?php endif; ?><?php endif; ?></td>
		<td><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'editSubscription','path' => ((is_array($_tmp='institutional')) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['subscription']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['subscription']->getId()))), $this);?>
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.edit"), $this);?>
</a><?php if (! $this->_tpl_vars['isNonExpiring']): ?>&nbsp;|&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'renewSubscription','path' => ((is_array($_tmp='institutional')) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['subscription']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['subscription']->getId()))), $this);?>
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.subscriptions.renew"), $this);?>
</a><?php endif; ?>&nbsp;|&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'deleteSubscription','path' => ((is_array($_tmp='institutional')) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['subscription']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['subscription']->getId()))), $this);?>
