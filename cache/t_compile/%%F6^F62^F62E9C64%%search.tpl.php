...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'search/search.tpl', 21, false),array('function', 'call_hook', 'search/search.tpl', 26, false),array('function', 'translate', 'search/search.tpl', 28, false),array('function', 'html_options', 'search/search.tpl', 39, false),array('function', 'page_links', 'search/search.tpl', 210, false),array('modifier', 'escape', 'search/search.tpl', 28, false),array('modifier', 'strip_unsafe_html', 'search/search.tpl', 157, false),array('modifier', 'to_array', 'search/search.tpl', 180, false),array('block', 'iterate', 'search/search.tpl', 145, false),)), $this); ?>
...
<div id="search">
	...
	<form method="get" id="searchForm" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'search'), $this);?>
">
		<table class="data">
			<tr valign="top">
...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('queryFilter', ob_get_contents());ob_end_clean(); ?>
					<?php if (empty ( $this->_tpl_vars['queryFilter'] )): ?>
						<input type="text" id="query" name="query" size="40" placeholder="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "search.searchAllCategories"), $this);?>
" maxlength="255" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['query'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" class="textField" />
					<?php else: ?>
...
" style="margin-top: 15px; width: auto;" class="button defaultButton" /></p>
...
" class="endseparator">&nbsp;</td></tr>
		<?php else: ?>
			<tr>
				<td <?php if (! $this->_tpl_vars['currentJournal']): ?>colspan="2" <?php endif; ?>align="left"><?php echo $this->_tpl_vars['pagination']; ?>
 </td>
