<?php /* Smarty version 2.6.26, created on 2019-02-04 13:17:18
         compiled from author/submit/step1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submit/step1.tpl', 19, false),array('function', 'url', 'author/submit/step1.tpl', 23, false),array('function', 'fieldLabel', 'author/submit/step1.tpl', 54, false),array('function', 'html_options', 'author/submit/step1.tpl', 54, false),array('modifier', 'escape', 'author/submit/step1.tpl', 26, false),array('modifier', 'assign', 'author/submit/step1.tpl', 43, false),array('modifier', 'nl2br', 'author/submit/step1.tpl', 129, false),)), $this); ?>
...
<div><span style="margin-right: 20px;"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'sectionId','required' => 'true','key' => "section.section"), $this);?>
</span> <select name="sectionId" id="sectionId" size="1" class="selectMenu"><?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['sectionOptions'],'selected' => $this->_tpl_vars['sectionId']), $this);?>
</select></div>
...
?>
	<?php if ($this->_tpl_vars['checklistItem']['content']): ?>
		...
		<?php endif; ?>
		<tr valign="top">
			<td width="3%"><input type="checkbox" id="checklist-<?php echo $this->_foreach['checklist']['iteration']; ?>
...
"<?php if ($this->_tpl_vars['articleId'] || $this->_tpl_vars['submissionChecklist']): ?> checked="checked"<?php endif; ?> /></td>
			<td ><label for="checklist-<?php echo $this->_foreach['checklist']['iteration']; ?>
