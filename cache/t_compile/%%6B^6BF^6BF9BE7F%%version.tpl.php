<?php /* Smarty version 2.6.26, created on 2021-01-07 21:54:23
...
<?php echo ''; ?><?php $this->assign('pageTitle', "rt.admin.versions.edit.editVersion"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<form action="<?php if ($this->_tpl_vars['versionId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'saveVersion','path' => $this->_tpl_vars['versionId']), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createVersion','path' => 'save'), $this);?>
...
" size="60" /></td>
	...
	<tr valign="top">
		...
		<td class="value"><input type="text" class="textField" name="key" id="key" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="60" /></td>
	</tr>
	<tr valign="top">
		...
		<td class="value"><input type="text" class="textField" name="locale" id="locale" maxlength="5" size="5" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['locale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" /></td>
	</tr>
	<tr valign="top">
