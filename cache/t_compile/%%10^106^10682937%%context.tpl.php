<?php /* Smarty version 2.6.26, created on 2021-01-07 21:55:09
...
<?php echo ''; ?><?php $this->assign('pageTitle', "rt.admin.contexts.edit.editContext"); ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<form action="<?php if ($this->_tpl_vars['contextId']): ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'saveContext','path' => ((is_array($_tmp=$this->_tpl_vars['versionId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['contextId']) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['contextId']))), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'createContext','path' => ((is_array($_tmp=$this->_tpl_vars['versionId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, 'save') : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, 'save'))), $this);?>
...
<table class="data" width="100%">
	<tr valign="top">
		...
		<td class="value" width="80%"><input type="text" class="textField" name="title" id="title" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="60" /></td>
	</tr>
	<tr valign="top">
		...
		<td class="value"><input type="text" class="textField" name="abbrev" id="abbrev" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['abbrev'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="60" /></td>
	</tr>
	<tr valign="top">
		...
		<td class="value">
			<textarea class="textArea" name="description" id="description" rows="5" cols="60"><?php echo ((is_array($_tmp=$this->_tpl_vars['description'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</textarea>
		</td>
	</tr>
	<tr valign="top">
