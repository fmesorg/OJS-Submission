<?php /* Smarty version 2.6.26, created on 2017-06-08 12:31:15
         compiled from file:/home/25160-62955.cloudwaysapps.com/frgmxhwawa/public_html/submission//plugins/generic/timedView/timedViewReportForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'file:/home/25160-62955.cloudwaysapps.com/frgmxhwawa/public_html/submission//plugins/generic/timedView/timedViewReportForm.tpl', 14, false),array('function', 'fieldLabel', 'file:/home/25160-62955.cloudwaysapps.com/frgmxhwawa/public_html/submission//plugins/generic/timedView/timedViewReportForm.tpl', 19, false),array('function', 'html_select_date', 'file:/home/25160-62955.cloudwaysapps.com/frgmxhwawa/public_html/submission//plugins/generic/timedView/timedViewReportForm.tpl', 20, false),array('function', 'translate', 'file:/home/25160-62955.cloudwaysapps.com/frgmxhwawa/public_html/submission//plugins/generic/timedView/timedViewReportForm.tpl', 34, false),array('modifier', 'escape', 'file:/home/25160-62955.cloudwaysapps.com/frgmxhwawa/public_html/submission//plugins/generic/timedView/timedViewReportForm.tpl', 49, false),)), $this); ?>
<?php $this->assign('pageTitle', "plugins.generic.timedView.displayName"); ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<p>
		<input type="submit" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.generic.timedView.form.generate"), $this);?>
...
<h3><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.generic.timedView.form.clearLogs"), $this);?>
</h3>
<form method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => 'TimedViewReportPlugin'), $this);?>
">
	<p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.generic.timedView.form.clearLogs.description"), $this);?>
</p>
	...
	<p>
		<input type="submit" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => 'plugins.generic.timedView.form.clearLogs'), $this);?>
" onclick="return confirm('<?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.generic.timedView.form.clearLogs.confirm"), $this))) ? $this->_run_mod_handler('escape', true, $_tmp, 'jsparam') : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp, 'jsparam'));?>
')" class="button defaultButton" />
	</p>
