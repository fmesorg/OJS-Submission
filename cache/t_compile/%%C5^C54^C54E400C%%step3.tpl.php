<?php /* Smarty version 2.6.26, created on 2018-04-06 10:58:00
         compiled from author/submit/step3.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'author/submit/step3.tpl', 25, false),array('function', 'fieldLabel', 'author/submit/step3.tpl', 79, false),array('function', 'form_language_chooser', 'author/submit/step3.tpl', 113, false),array('function', 'translate', 'author/submit/step3.tpl', 115, false),array('function', 'html_options', 'author/submit/step3.tpl', 223, false),array('function', 'call_hook', 'author/submit/step3.tpl', 253, false),array('modifier', 'assign', 'author/submit/step3.tpl', 25, false),array('modifier', 'escape', 'author/submit/step3.tpl', 35, false),)), $this); ?>
...
]" class="textArea" id="authors-0-affiliation" rows="5" cols="40"></textarea>
	</td>

</tr>
<tr>
	<td></td>
    <td><span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.affiliation.description"), $this);?>
</span></td>
</tr>
...
<tr valign="top">
	...
	<td width="30%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => "authors-0-url",'required' => 'true','key' => "user.url"), $this);?>
</td>
...
<p class="sub-step-3-add-author"><input type="submit" class="button" name="addAuthor" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.addAuthor"), $this);?>
" /></p>
...
<tr valign="top">
	...
	<td width="10%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'title','required' => 'true','key' => "article.title"), $this);?>
</td>

	<td width="90%" class="value"><input type="text" class="textField" name="title[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<tr valign="top">
	...
	<td width="10%" class="label"><?php if ($this->_tpl_vars['section']->getAbstractsNotRequired() == 0): ?><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'abstract','key' => "article.abstract",'required' => 'true'), $this);?>
<?php else: ?><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'abstract','key' => "article.abstract"), $this);?>
<?php endif; ?></td>

	<td width="90%" class="value"><textarea name="abstract[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<?php if ($this->_tpl_vars['section']->getMetaIndexed() == 1): ?>
	...
	<div id="indexing">
		...
		<tr valign="top">
			...
			<td<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('metaDisciplineExamples') != ''): ?> rowspan="2"<?php endif; ?> width="10%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'discipline','key' => "article.discipline"), $this);?>
</td>

			<td width="90%" class="value"><input type="text" class="textField" name="discipline[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
" size="40" maxlength="255" /></td>
		...
		<tr valign="top">
			...
			<td width="30%" class="label"><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('metaSubjectClassUrl'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" target="_blank"><?php echo ((is_array($_tmp=$this->_tpl_vars['currentJournal']->getLocalizedSetting('metaSubjectClassTitle'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
		...
		<tr valign="top">
			...
			<td<?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('metaSubjectExamples') != ''): ?> rowspan="2"<?php endif; ?> width="10%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'subject','key' => "article.subject"), $this);?>
</td>

			<td width="90%" class="value"><input type="text" class="textField" name="subject[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
" size="40" maxlength="255" /></td>
		...
		<tr valign="top">
			...
			<td width="30%" <?php if ($this->_tpl_vars['currentJournal']->getLocalizedSetting('metaTypeExamples') != ''): ?>rowspan="2" <?php endif; ?>class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'type','key' => "article.type"), $this);?>
</td>
...
" size="5" maxlength="10" /></td>
		...
		<tr valign="top">
			...
			<td colspan="2"><span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.languageInstructions"), $this);?>
</span></td>
...
<tr valign="top">
	...
	<td width="10%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'sponsor','key' => "submission.agencies"), $this);?>
</td>

	<td width="90%" class="value"><input type="text" class="textField" name="sponsor[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
...
<p class="sub-step-3-SaveCancelBut"><input type="submit" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.saveAndContinue"), $this);?>
...
<p class="sub-step-3-SaveCancelBut"><span class="formRequired"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.requiredField"), $this);?>
</span></p>
