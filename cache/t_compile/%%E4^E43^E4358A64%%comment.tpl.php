<?php /* Smarty version 2.6.26, created on 2016-11-21 11:56:42
         compiled from comment/comment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'comment/comment.tpl', 30, false),array('modifier', 'default', 'comment/comment.tpl', 40, false),array('modifier', 'to_array', 'comment/comment.tpl', 42, false),array('function', 'url', 'comment/comment.tpl', 42, false),array('function', 'translate', 'comment/comment.tpl', 45, false),array('function', 'fieldLabel', 'comment/comment.tpl', 75, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['captchaEnabled']): ?>
	<tr valign="top">
		...
		<td class="value">
			<img style="margin-top: 5px; border: 1px solid #ccc;" src="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'user','op' => 'viewCaptcha','path' => $this->_tpl_vars['captchaId']), $this);?>
