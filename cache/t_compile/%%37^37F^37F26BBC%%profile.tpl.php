<?php /* Smarty version 2.6.26, created on 2018-04-05 19:47:50
         compiled from user/profile.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'user/profile.tpl', 23, false),array('function', 'fieldLabel', 'user/profile.tpl', 45, false),array('function', 'form_language_chooser', 'user/profile.tpl', 51, false),array('function', 'translate', 'user/profile.tpl', 53, false),array('function', 'html_options_translate', 'user/profile.tpl', 120, false),array('function', 'html_options', 'user/profile.tpl', 200, false),array('modifier', 'assign', 'user/profile.tpl', 23, false),array('modifier', 'escape', 'user/profile.tpl', 65, false),array('modifier', 'date_format', 'user/profile.tpl', 280, false),)), $this); ?>
...
<tr valign="top">
	...
	<td width="15" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('suppressId' => 'true','name' => 'username','key' => "user.username"), $this);?>
</td>

	<td width="85%" class="value textField"><?php echo ((is_array($_tmp=$this->_tpl_vars['username'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</td>
...
<tr>
	<td></td>
    <td><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.initialsExample"), $this);?>
</td>
</tr>
...
<p class="edit-prof-saveSubButton"><input type="submit" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.save"), $this);?>
