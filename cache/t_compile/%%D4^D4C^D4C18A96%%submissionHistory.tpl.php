<?php /* Smarty version 2.6.26, created on 2018-04-06 09:38:10
         compiled from sectionEditor/submissionHistory.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'sectionEditor/submissionHistory.tpl', 12, false),array('function', 'url', 'sectionEditor/submissionHistory.tpl', 49, false),array('function', 'icon', 'sectionEditor/submissionHistory.tpl', 82, false),array('modifier', 'assign', 'sectionEditor/submissionHistory.tpl', 12, false),array('modifier', 'date_format', 'sectionEditor/submissionHistory.tpl', 78, false),array('modifier', 'concat', 'sectionEditor/submissionHistory.tpl', 80, false),array('modifier', 'to_array', 'sectionEditor/submissionHistory.tpl', 81, false),array('modifier', 'translate', 'sectionEditor/submissionHistory.tpl', 81, false),array('modifier', 'escape', 'sectionEditor/submissionHistory.tpl', 82, false),array('modifier', 'strip_tags', 'sectionEditor/submissionHistory.tpl', 87, false),array('modifier', 'truncate', 'sectionEditor/submissionHistory.tpl', 87, false),array('modifier', 'strip_unsafe_html', 'sectionEditor/submissionHistory.tpl', 172, false),array('modifier', 'nl2br', 'sectionEditor/submissionHistory.tpl', 172, false),array('block', 'iterate', 'sectionEditor/submissionHistory.tpl', 76, false),)), $this); ?>
...
<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'clearSubmissionEventLog','path' => $this->_tpl_vars['submission']->getId()), $this);?>
...
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.view"), $this);?>
</a><?php if ($this->_tpl_vars['isEditor']): ?>&nbsp;|&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'clearSubmissionEmailLog','path' => ((is_array($_tmp=$this->_tpl_vars['submission']->getId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['logEntry']->getId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['logEntry']->getId()))), $this);?>
...
<a class="action" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'clearsubmissionEmailLog','path' => $this->_tpl_vars['submission']->getId()), $this);?>
