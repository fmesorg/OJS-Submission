...
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_select_date', 'search/searchFilter.tpl', 32, false),array('function', 'call_hook', 'search/searchFilter.tpl', 40, false),array('function', 'url', 'search/searchFilter.tpl', 64, false),array('function', 'translate', 'search/searchFilter.tpl', 70, false),array('modifier', 'escape', 'search/searchFilter.tpl', 42, false),array('modifier', 'cat', 'search/searchFilter.tpl', 51, false),)), $this); ?>
...
" size="40" maxlength="255" placeholder="<?php echo $this->_tpl_vars['filterName']; ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['filterValue'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" placeholder="<?php echo $this->_tpl_vars['filterName']; ?>
" class="textField">
				<?php else: ?>
