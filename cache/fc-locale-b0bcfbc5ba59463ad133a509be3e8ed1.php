<?php return array (
  ...
  'plugins.pubIds.doi.manager.settings.doiSuffixPublisherId' => 'Use the "Custom Identifier" for published items as the DOI suffix (must be enabled in Step 4). This is the same identifier that will be used for public URLs.',
